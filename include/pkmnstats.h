...
static const struct pkmn_base_stats pkmn_base_stats_gen2[MAX_SPECIES_INDEX + 1] = {
    ...
    [CHARMANDER] = {.max_hp = 39, .atk = 52, .def = 43, .spd = 65, .spcl = 50},
    ...
    [GYARADOS] = {.max_hp = 95, .atk = 125, .def = 79, .spd = 100, .spcl = 100},
...
static const struct pkmn_base_stats pkmn_base_stats_gen1[SI_VICTREEBEL + 1] = {
    ...
    [SI_GYARADOS] = {.max_hp = 95, .atk = 125, .def = 79, .spd = 100, .spcl = 100, .catch_rate = 45, .types = {PKSAV_GEN1_TYPE_WATER, PKSAV_GEN1_TYPE_FLYING}},
