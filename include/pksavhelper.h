...
void swap_party_pkmn_at_indices(struct pksav_gen2_save *save, uint8_t pkmn_index1, uint8_t pkmn_index2); // TODO: Update for cross-generation
...
void update_seen_owned_pkmn(PokemonSave *save, uint8_t pkmn_party_index);
