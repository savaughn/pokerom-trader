    ...
    uint8_t *p_buffer)
{
    ...
    p_save_time->p_time_played = (struct pksav_gen2_time *)(&p_buffer[p_offsets[PKSAV_GEN2_TIME_PLAYED]]);
    ...
    p_item_storage->p_item_bag = (struct pksav_gen2_item_bag *)(&p_buffer[p_offsets[PKSAV_GEN2_ITEM_BAG]]);
    p_item_storage->p_item_pc = (struct pksav_gen2_item_pc *)(&p_buffer[p_offsets[PKSAV_GEN2_ITEM_PC]]);
    ...
    for (size_t box_index = 0; box_index < 7; ++box_index)
    {
        ...
        p_pokemon_storage->pp_boxes[box_index] = (struct pksav_gen2_pokemon_box *)(&p_buffer[offset]);
    }
