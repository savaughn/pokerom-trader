...
#------------------------------------------------------------------------------------------------
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -Isrc/ -Ideps/pksav/include 
...
# CC = gcc
# CFLAGS = -Ideps/pksav/include -Ldeps/pksav/lib -lpksav -I../raylib/src/ -L../raylib/src/ -lraylib
